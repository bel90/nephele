...
public abstract class AbstractInstance extends NetworkNode {
	 ...
	 * @author bel
	 */
	public synchronized void changeCheckpoint(final ExecutionVertexID id, CheckpointState newState) throws IOException,
			InterruptedException {

		getTaskManagerProxy().changeCheckpoint(id, newState);
	}
