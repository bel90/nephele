...
public interface TaskOperationProtocol extends RPCProtocol {
	...
	void changeCheckpoint(ExecutionVertexID id, CheckpointState newState) throws IOException, InterruptedException;
	//void changeCheckpoint(ExecutionVertexID id) throws IOException, InterruptedException;
	/**
