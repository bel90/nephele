...
public class ServerTypeUtils {
	...
	public static List<Class<?>> getRPCTypesToRegister() {
		...
		types.add(CheckpointDecisionReason.class);
		types.add(TaskCheckpointDecisionReason.class);
		types.add(TaskCheckpointSize.class);
		types.add(TaskRecordSkipped.class);
