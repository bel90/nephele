 ...
 * @author warneke
 */
public final class InstanceConnectionInfo implements Comparable<InstanceConnectionInfo>, Serializable {
	...
	public String toString() {
		...
		if (this.hostName != null) {
			iaString = this.hostName + inetAddress.toString();
		} else {
	...
	public int compareTo(final InstanceConnectionInfo o) {
		...
		return this.getHostName()
			.compareTo(((InstanceConnectionInfo) o).getHostName());
	}
