...
public final class TaskDeploymentDescriptor implements KryoSerializable {
	...
	public void write(final Kryo kryo, final Output output) {
		...
		if(this.failureReport != null){
			...
			kryo.writeObject(output, this.failureReport);
		}else{
	...
	public void read(final Kryo kryo, final Input input) {
		...
		if(input.readBoolean()){
			this.failureReport = kryo.readObject(input, FailureReport.class);
		}
	}
	...
	public void addFailureReport(FailureReport lastFailureReport) {
		this.failureReport= lastFailureReport;
	}
