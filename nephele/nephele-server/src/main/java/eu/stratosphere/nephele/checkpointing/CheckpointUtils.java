...
public final class CheckpointUtils {
	...
	public static float getUpperBound(){
		final String mode = GlobalConfiguration.getString("checkpoint.upperbound", "1.0");
		return Float.parseFloat(mode);
	}
	
	public static float getLowerBound(){
		final String mode = GlobalConfiguration.getString("checkpoint.lowerbound", "0.2");
		return Float.parseFloat(mode);
	}
	...
	public static boolean getUsingCL() {
		return true;
	}
}
