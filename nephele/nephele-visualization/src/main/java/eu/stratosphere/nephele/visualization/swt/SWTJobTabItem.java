...
public class SWTJobTabItem extends Composite implements Listener {
	...
	public void changeCheckpoint(ManagementVertexID id, boolean checkpoint) {
		// Delegate call to the main GUI
		this.visualizationGUI.changeCheckpoint(this.visualizationData.getJobID(), id, checkpoint);
	}
