...
public class ColorScheme {
	...
	// Checkpoint colors
	private final Color CHECKPOINTUNDECIDED;
	
	private final Color CHECKPOINTPARTIAL;
	
	private final Color CHECKPOINTCOMPLETE;
	
	private final Color CHECKPOINTNONE;
	...
	private ColorScheme(Device device) {
		...
		//TODO set different Colors for the Checkpoint States
		this.CHECKPOINTUNDECIDED = new Color(device, 255, 255, 0);
		this.CHECKPOINTPARTIAL = new Color(device, 170, 255, 155);
		this.CHECKPOINTCOMPLETE = new Color(device, 62, 255, 28);
		this.CHECKPOINTNONE = new Color(device, 255, 179, 28);
	...
	public static Color getCheckpointUndecidedColor(Device device) {
		return getInstance(device).CHECKPOINTUNDECIDED;
	}
	
	public static Color getCheckpointPartialColor(Device device) {
		return getInstance(device).CHECKPOINTPARTIAL;
	}
	
	public static Color getCheckpointCompleteColor(Device device) {
		return getInstance(device).CHECKPOINTCOMPLETE;
	}
	
	public static Color getCheckpointNoneColor(Device device) {
		return getInstance(device).CHECKPOINTNONE;
	}
