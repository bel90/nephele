...
public interface ExtendedManagementProtocol extends JobManagementProtocol {
	...
	/**
	 * If the status is true, the checkpoint is tried to set to partial, otherwise none.
	 * @param jobID
	 * @param id
	 * @param newState
	 * @throws IOException
	 ...
	 * @author bel
	 */
	void changeCheckpoint(final JobID jobID, final ManagementVertexID id, final boolean newState)  throws IOException, InterruptedException; 
